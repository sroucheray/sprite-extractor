...
(function(process) {
 ...
 while ((b = b.parentNode) && 1 === b.nodeType);
    ...
    kb.fn.extend({
      ...
      set: Cb.set
    }, kb.attrHooks.contenteditable = {set: function(a, b, c) {
        Cb.set(a, "" === b ? !1 : b, c);
    ...
    kb.fn.extend({
      ...
      closest: function(a, b) {
        for (var c,
            ...
            e = this.length,
            f = [],
            g = Sb.test(a) || "string" != typeof a ? kb(a, b || this.context) : 0; e > d; d++)
      ...
      dir: function(a, c, d) {
        for (var e = [],
            f = a[c]; f && 9 !== f.nodeType && (d === b || 1 !== f.nodeType || !kb(f).is(d)); )
    ...
    gc.optgroup = gc.option, gc.tbody = gc.tfoot = gc.colgroup = gc.caption = gc.thead, gc.th = gc.td, kb.fn.extend({
      ...
      cleanData: function(a, b) {
        for (var c,
            ...
            k = kb.event.special; null != (c = a[g]); g++)
 ...
 while (h !== (h = c.cur() / d) && 1 !== h && --i);
    ...
    }, R.prototype.init.prototype = R.prototype, R.propHooks = {_default: {
        get: function(a) {
          var b;
 ...
 while (document.getElementById(a));
    ...
    function b(a, b, e) {
      ...
      if (/^(ch|di|in)/.test(e) && !h)
        ...
        b && "toggle" != e || (b || a[_callback]("ifClicked"), h ? f[_type] !== k && d(a, g) : c(a, g));
    }
    function c(b, c, e) {
      var o = b[0],
          p = b.parent(),
    ...
    _determinate = "determinate", _indeterminate = "in" + _determinate, _update = "update", _type = "type", _click = "click", _touch = "touchbegin.i touchend.i", _add = "addClass", _remove = "removeClass", _callback = "trigger", _label = "label", _cursor = "cursor", _mobile = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent), a.fn[i] = function(f, g) {
      ...
      if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(f))
        return f = f.toLowerCase(), o(this), m.each(function() {
          var c = a(this);
        ...
        y && x.each(function() {
          ...
          if (!g[n]) {
            if (d == _click) {
              ...
              u && (/ut|nd/.test(d) ? (A[_remove](r), e[_remove](v)) : (A[_add](r), e[_add](v)));
            if (!_mobile)
              return !1;
            c.stopPropagation();
          }
          ...
          var c = a[_type],
              d = /wn|up/.test(c) ? t : r;
          if (!g[n]) {
            if (c == _click ? b(f, !1, !0) : (/wn|er|in/.test(c) ? A[_add](d) : A[_remove](d + " " + t), x.length && u && d == r && x[/ut|nd/.test(c) ? _remove : _add](v)), !_mobile)
              return !1;
            a.stopPropagation();
          }
        });
